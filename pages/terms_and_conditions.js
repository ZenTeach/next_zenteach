		...
		<SiteLayout>
			<div className="h-full bg-grey mt-8 sm:mt-0 sm:py-12 max-w-4xl mx-auto px-8">
				...
				<p className="my-2">
					...
					which such content originated. We accept no responsibility for, and do not guarantee, the accuracy,
					integrity or quality of any User-Uploaded Content.

					Please be aware that any user who is aggrieved by your User-Uploaded Content may take legal action
					against you. This could result in data concerning your identity being disclosed and you having to pay
					compensation to the aggrieved party.

					We do not pre-screen User-Uploaded Content but we have the right to monitor User-Uploaded Content if we
				...
				<p className="my-2">
					...
					we require a licence. Similarly, third party users of our Websites will require a licence from you to enable
					them to make use of your User-Uploaded Content.

					The licence you grant us and each of our affiliates is non-exclusive, sub-licensable, worldwide, fully paid-up,
					royalty-free, perpetual and irrevocable (save as set out below). This means that we can use, reproduce, publish,
					distribute and display your User-Uploaded Content (in whole or in part) and/or incorporate it in other works in any
					form, media, or technology. Third party users are allowed to download and/or otherwise use your User-Uploaded
					Content under an Attribution License:
					<ul>
						<li><span className="font-bold">Share</span> — copy and redistribute the material in any medium or format</li>
				...
				<p className="my-2">
					...
					third party web sites or services. You further acknowledge and agree that ZenTeach shall not be responsible or liable,
