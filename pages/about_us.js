			...
			<div className="h-screen md:h-screen mt-4 pt-4">
				<div className="flex flex-row">
					<div className="w-full bg-gradient-to-r from-rose-50 to-rose-100">
						<div className="text-2xl md:text-5xl p-3 text-center">Meet the Team</div>
					</div>
				</div>
				<div className="w-full flex flex-col md:flex-row md:justify-center m-5 p-8 flex">
					<div className="max-w-sm w-auto h-1/5 mx-4 my-4 flex flex-col justify-center overflow-hidden">
						...
						<div className="px-6 py-4 text-center">
							<div className="font-bold text-md md:text-xl mb-2">Philipp Herzberg</div>
							<span className="font-normal md:font-thin text-xs md:text-md mb-2">Business & Marketing</span>
						</div>
						<div className="px-6 pt-4 pb-2 w-full flex justify-center text-center">
					...
					<div className="max-w-sm w-auto h-1/5 mx-4 my-4 flex flex-col justify-center overflow-hidden">
						...
						<div className="px-6 py-4 text-center">
							<div className="font-bold text-md md:text-xl mb-2">Natnael Getahun</div>
							<span className="font-normal md:font-thin text-xs md:text-md mb-2">Tech & Product</span>
						</div>
						<div className="px-6 pt-4 pb-2 w-full flex justify-center text-center">
							<div className="p-2 content-around space-around">
