...
const Footer = ({}) => (
	<div class="h-full bg-black-lighter border-black border-1 p-8">
		<div class="sm:flex mb-4">
			...
			<div class="sm:w-1/2 sm:mt-0 mt-8 h-auto">
				<div class="text-2xl font-bold mb-2">Newsletter</div>
				<p class="text-grey-darker leading-normal">Join our community and stay in touch with us!</p>
				<div class="mt-4 flex">
					<input type="text" class="p-2 border border-grey-light round text-grey-dark text-sm h-auto" placeholder="Your email address" />
					<button class="bg-black text-white rounded-sm h-auto text-xs p-3">Subscribe</button>
				</div>
			</div>
		</div>
	</div>
